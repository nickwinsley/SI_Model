...
is known to asymptotically converge to a $\chi^{2}$ distribution with $(I - 1)(J - 1)$ degrees of freedom, where I and J are the number of rows and columns respectively in the contingency table.
...
kable(output, caption = "Chi-Squared Test Results")
```
