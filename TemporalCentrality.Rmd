...
The Hochberg procedure is a powerful method that performs well for positively correlated test statistics. The Hochberg procedure is well-suited for epidemiology data, where positive dependency between infection events is likely. The Hochberg Procedure generally provides greater power than Holm's method and the Bonferroni Correction.
