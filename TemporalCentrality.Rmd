...
$$e^{\sum_{w \in E}{log(w)}}$$
All highest-probability paths to $\textit{u}_{i}$ can be calculated in $O(i|V|^{2})$ runtime using a modified version of the Reversed Evolution Network (REN) algorithm proposed by @hanke2017clone. Algorithm 1 shows the psuedocode for this algorithm.
