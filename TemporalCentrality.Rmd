...
Pairwise comparisons were carried out with Fisher's Exact Test and p-values were simulated by a permutation test to reduce computation time. The results are shown in table 4.
