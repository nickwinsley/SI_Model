...
tp_rmse <- rmse(data$TC, data$likelihood)
tpp_rmse <- rmse(data$TP, data$likelihood)
tbc_rmse <- rmse(data$TBC, data$likelihood)

rmse_vec <- c(full_rmse, abs_rmse, deg_rmse, tpp_rmse, tbc_rmse)

names(rmse_vec) <- c("Final Model", "Absorb", "Degree", "TP", "TBC")
